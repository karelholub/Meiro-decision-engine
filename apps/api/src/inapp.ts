...
export const inAppEventsBodySchema = z.object({
  ...
  tracking: z.object({
    ...
    native_meiro_campaign_id: z.string().min(1).optional(),
    creative_asset_id: z.string().min(1).optional(),
    native_meiro_asset_id: z.string().min(1).optional(),
    offer_catalog_id: z.string().min(1).optional(),
    native_meiro_catalog_id: z.string().min(1).optional(),
    prism_source_id: z.string().min(1).optional(),
    imported_from: z.string().min(1).optional(),
